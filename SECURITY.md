...
| --------------- | --------- | --------------------------------- |
| Último tag `v*` | Sí        | Releases documentados               |
| `master`        | Sí        | Rama desplegada a producción      |
...
Si el buzón no está disponible, usa **[contacto@geminislabs.com](mailto:contacto@geminislabs.com)** con asunto `SECURITY: gac-api`.
...
- **Nunca** commitees secretos JWT, PASETO ni credenciales de DB
